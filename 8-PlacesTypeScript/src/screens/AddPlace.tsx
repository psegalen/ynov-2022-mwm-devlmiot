...
import { PlacesParamList } from "../Navigation";
...
const AddPlace: FC<NativeStackScreenProps<PlacesParamList, "AddPlace">> = (
  props
) => {
      ...
      {place ? (
        <View style={addStyles.formContainer}>
          ...
          <Picker
            ...
            onValueChange={(itemValue) => setRate(parseInt(itemValue))}
          >
